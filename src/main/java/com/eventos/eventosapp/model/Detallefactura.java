...
@NamedQueries({
    ...
    , @NamedQuery(name = "Detallefactura.findByTotalCompra", query = "SELECT d FROM Detallefactura d WHERE d.totalCompra = :totalCompra")})
public class Detallefactura implements Serializable {
    ...
    public String toString() {
        return "com.eventos.eventosapp.model.Detallefactura[ idDetalleFactura=" + idDetalleFactura + " ]";
    }
